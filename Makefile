...
# $Id: Makefile,v 1.46.2.1 2010/11/19 20:09:30 rhuey Exp $
# 
# AutoDock 
# 
...
am_libad_a_OBJECTS = analysis.$(OBJEXT) \
	...
	nbe.$(OBJEXT) pso.$(OBJEXT) call_cpso.$(OBJEXT)
...
ACLOCAL = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run aclocal-1.10
AMTAR = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run tar
AUTOCONF = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run autoconf
AUTOHEADER = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run autoheader
AUTOMAKE = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run automake-1.10
AWK = gawk
CC = gcc
...
CXXFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"autodock\" -DPACKAGE_TARNAME=\"autodock\" -DPACKAGE_VERSION=\"4.0.1\" -DPACKAGE_STRING=\"autodock\ 4.0.1\" -DPACKAGE_BUGREPORT=\"autodock@scripps.edu\" -DPACKAGE=\"autodock\" -DVERSION=\"4.0.1\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE__BOOL=1 -DHAVE_STDBOOL_H=1 -DHAVE_STDLIB_H=1 -DHAVE_MALLOC=1 -DHAVE_GETHOSTNAME=1 -DHAVE_STRNCASECMP=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = autodock
...
STRIP = 
VERSION = 4.0.1
abs_builddir = /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4
abs_srcdir = /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4
abs_top_builddir = /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4
abs_top_srcdir = /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /mgl/works/rhuey/autodock_1/files_from_chenlongs_student/mlsd_ad4/install-sh
...
autodock4$(EXEEXT): $(autodock4_OBJECTS) $(autodock4_DEPENDENCIES) 
	...
	$(autodock4_LINK) $(autodock4_OBJECTS) $(autodock4_LDADD) $(LIBS)
