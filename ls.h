/*
 ...
 $Id: ls.h,v 1.5.2.1 2010/11/19 20:09:29 rhuey Exp $
...
class Local_Search
{
   public:
      ...
      virtual int searchByPSO(Individual &) = 0; 
};
...
class Solis_Wets_Base : public Local_Search
{
   ...
   public:
      ...
      virtual void SWMultiLigand(Phenotype &, int , int , int ) = 0;
...
class Solis_Wets : public Solis_Wets_Base
{
   ...
   public:
      ...
      virtual double gen_deviates(Real) = 0;
      void SW(Phenotype &);
      void SWMultiLigand(Phenotype &vector, int from_gene_point, int to_gene_point, int ilig);
};
