/*
 ...
 $Id: parse_dpf_line.cc,v 1.4 2005/03/11 02:11:30 garrett Exp $
...

{
    ...
    const int tokentablesize = 95;
#else
    const int tokentablesize = 94;
#endif
    ...
    const struct {
       ...
       int tokenvalue;
              ...
              , {"epdb", DPF_EPDB}      // 94
#if defined(USING_COLINY)
              , {"coliny", DPF_COLINY}  // 95       // remember to set tokentablesize earlier
#endif
              }; // 94, or 95 if USING_COLINY      // remember to set tokentablesize earlier
