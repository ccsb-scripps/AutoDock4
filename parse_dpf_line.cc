/*
 ...
 $Id: parse_dpf_line.cc,v 1.15 2006/09/13 16:40:48 mchang Exp $
...
#define NUM_LEXEMES_AUTODOCK 108 // this is the length of the tokentable of AutoDock-related lexemes 
