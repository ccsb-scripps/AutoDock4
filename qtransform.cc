/*
 ...
 $Id: qtransform.cc,v 1.8.2.1 2010/11/19 20:09:29 rhuey Exp $
...
/*      Date: 11/23/94                                                        */
/*----------------------------------------------------------------------------*/
/*    Inputs: q, tcoord, from_atom, to_atom                                                 */
...
/* 10/20/2007 Huameng  change natom to from_atom, to_atom of true ligand  frpm_atom /. */
/******************************************************************************/
{
    register int a;
    Coord  tmp;
