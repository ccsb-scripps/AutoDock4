...
void spofa(float *a,FourByteLong lda,FourByteLong n,FourByteLong *info)
/*
...
*/
{
extern float sdot(FourByteLong n,float *sx,FourByteLong incx,float *sy,FourByteLong incy);
